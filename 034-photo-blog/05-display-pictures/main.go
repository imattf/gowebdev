...
func index(w http.ResponseWriter, req *http.Request) {
	...
	// pass a slice of bytes to range over the pictures (starting at bs[1:])in the template
	tmpl.ExecuteTemplate(w, "index.gohtml", xs[1:])
}
